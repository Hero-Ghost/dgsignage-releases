...
<p align="center">
  ...
  כאן מפורסמים כל קובצי ההתקנה הרשמיים, גרסאות ה-Portable ועדכוני המערכת האוטומטיים עבור מערכת השילוט הדיגיטלי.
</p>
...
* 🔒 **אבטחת מידע ופרטיות מלאה:** כל קובצי המדיה והנתונים נשמרים באופן מקומי בלבד. שום מידע אינו נשלח לענן חיצוני.
* 🔌 **עמידות מלאה לאופליין:** המערכת פועלת 100% מקומית ברשת ה-LAN ללא תלות בחיבור אינטרנט רציף.
...
flowchart TD
    ...
    subgraph GitHubRel ["GitHub (מאגר הפצה)"]
        Releases["GitHub Releases (עדכוני תוכנה רשמיים)"]
    end
